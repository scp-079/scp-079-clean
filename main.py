...
from plugins.functions.timers import backup_files, clean_banned, clean_members, interval_hour_01, interval_min_10
...
scheduler.add_job(clean_members, "cron", [app], hour=12)
